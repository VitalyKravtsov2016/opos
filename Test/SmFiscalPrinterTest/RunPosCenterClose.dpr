...
uses
  ...
  duPosCenterCloseEx4 in '..\AcceptanceTest\Units\duPosCenterCloseEx4.pas';

{$R SmFiscalPrinterTest.RES}
{$R ..\..\Source\SmFiscalPrinter\SmFiscalPrinter.TLB}

begin
  with TextTestRunner.RunTest(TPosCenterCloseEx4Test.Suite) do
  begin
