...
{ Runs only TMarkedReceiptDriversTest.CheckMarkedReceiptOnRR against
  TRRElectroFrEmulator on Com0Com COM12<->COM13 @ 115200. }
...
begin
  with TextTestRunner.RunTest(
    TMarkedReceiptDriversTest.Create('CheckMarkedReceiptOnRR')) do
  begin
    WriteLn(Format('Runs=%d Failures=%d Errors=%d',
