  ...
  try
    ...
    begin
      ...
      begin
        ...
        CloseParams2.TaxAmount[11] := StrToInt64Def(Parameters.Parameter12, 0); // РќР”РЎ 22%
        CloseParams2.TaxAmount[12] := StrToInt64Def(Parameters.Parameter13, 0); // РќР”РЎ 22/122
