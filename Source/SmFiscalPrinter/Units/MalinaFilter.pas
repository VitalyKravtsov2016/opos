...
begin
  ...
  Printer.PrintLines('������', IntToStr(Params.RosneftItemDepartment));
  PrintAmount('�������', FItemCount.Sale, FTotals.Sale);
  PrintAmount('�������', FItemCount.Buy, FTotals.Buy);
  PrintAmount('�����.�������', FItemCount.RetSale, FTotals.RetSale);
  PrintAmount('�����.�������', FItemCount.RetBuy, FTotals.RetBuy);
end;
