...
begin
  if Amount > FTotal then
    RaiseExtendedError(OPOS_EFPTR_NEGATIVE_TOTAL, _('������������� ���� ����'));
end;
...
begin
  ...
  case AdjustmentType of
    ...
    RaiseOposException(OPOS_E_ILLEGAL, _('�������� �������� ��������� AdjustmentType'));
  end;
end;
...
begin
  ...
  Printer.PrintDocHeader('�������', Parameters.ZeroReceiptNumber);
  Parameters.ZeroReceiptNumber := Parameters.ZeroReceiptNumber + 1;
  Printer.WaitForPrinting;

  Line := Printer.FormatBoldLines('�����', '=0');
